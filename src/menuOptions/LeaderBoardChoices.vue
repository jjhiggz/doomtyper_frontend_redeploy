<template>
  <div
    class="nes-container game-choice-container with-title is-centered id-dark"
  >
    <p class="title" id="title">LeaderBoardChoices</p>
    <nav id="mylist" class="list nes-list is-circle" v-if="renderChoices">
      <p
        :key="game.id"
        v-for="game in games"
        class="game-name"
...
export default {
  ...
  methods: {
    ...
    sortScores(scores) {
      ...
      } else this.scores = scores.slice(0, scores.length);
